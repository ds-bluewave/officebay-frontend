...
// import { fetchDesks, reserveDesk, releaseDesk, Desk, checkAvailability } from '../api/apiClient';
...
//   const [startTime, setStartTime] = useState<string>(getCurrentTimeAndOneMinuteLater());
...
//         const isAvailable = availableDesks.some(availableDesk => availableDesk.id === desk.id);
...
//       if (selectedDesk) {
//         const updatedDesk = updatedDesks.find(desk => desk.id === selectedDesk.id);
//         if (updatedDesk) {
//           setSelectedDesk(updatedDesk);
//         }
//       }
...
//     if (selectedDesk) {
//       try {
//         await releaseDesk(selectedDesk.id);
//         await fetchDesksData();
//       } catch (error) {
//         console.error('Error releasing desk:', error);
//         setError('Nie udało się zwolnić biurka');
//       }
//     }
//   };
...
//         <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Układ biura</h2>
...
//           </div>
//           <div>
//             <label className="block text-gray-700 dark:text-gray-300 mb-2">Od godziny</label>
//             <input
//               type="time"
//               value={startTime}
...
//           </div>
//           <div>
//             <label className="block text-gray-700 dark:text-gray-300 mb-2">Do godziny</label>
//             <input
//               type="time"
//               value={endTime}
...
//         <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg fixed align-middle content-center">
...
//       <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
//         <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Wybrane biurko</h2>
//         {selectedDesk ? (
//           <div className="space-y-2">
//             <div className="grid grid-cols-2 gap-4">
//               <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded">
//                 <span className="text-gray-500 dark:text-gray-400 text-sm">ID</span>
//                 <p className="font-medium text-gray-900 dark:text-white">{selectedDesk.id}</p>
//               </div>
//               <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded">
//                 <span className="text-gray-500 dark:text-gray-400 text-sm">Nazwa</span>
//                 <p className="font-medium text-gray-900 dark:text-white">{selectedDesk.name}</p>
//               </div>
//               <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded">
//                 <span className="text-gray-500 dark:text-gray-400 text-sm">Typ</span>
//                 <p className="font-medium text-gray-900 dark:text-white">{selectedDesk.type}</p>
//               </div>
//               <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded">
//                 <span className="text-gray-500 dark:text-gray-400 text-sm">Status</span>
//                 <p className={`font-medium ${selectedDesk.isAvailable ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
